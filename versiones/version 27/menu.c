...
void dibujoMision() {
    ...
    puts("3. Modificar una mision (EN VUELO)");
...
void opcionMostrarMisiones(char archivoMisiones[],char archivoNaves[])
{
    ...
    do {
        ...
        case 1:
            ...
            break;
        case 2:
            mostrarMisionesXEstado(archivoMisiones,1);
            break;
        case 3:
            mostrarMisionesXEstado(archivoMisiones,2);
            break;
        case 4:
             mostrarMisionesXEstado(archivoMisiones,3);
            break;
        case 5:
            mostrarMisionesXEstado(archivoMisiones,4);
            break;
        case 6:
            mostrarMisionesXEstado(archivoMisiones,5);
            break;
        default:
            printf("Por favor ingrese una opcion valida \n");
            break;
