...
void dibujoMision() {
    ...
    puts("2. Mostrar misiones");
    puts("3. Consultar datos de una mision");
...
void opcionMostrarMisiones(char archivoMisiones[], int maxTripulantes){
    ...
    do {
        ...
        puts("2. Mostrar las misiones disponibles (Estado= 0)");
        puts("3. Mostrar las misiones en curso    (Estado= 1)");  // (Listo, En vuelo, Retornada, Cancelada, Fallida)
        puts("4. Mostrar las misiones retornadas  (Estado= 2)");
        puts("5. Mostrar las misiones canceladas  (Estado= 3)");
        puts("6. Mostrar las misiones fallidas    (Estado= 4)");
        puts("--------------------------------------------------------");
        opsw = preguntarDato();
        limpiarPantalla();
        switch(opsw) {
        case 1:
            mostrarTodasLasMisiones(archivoMisiones);
            break;
        case 2:
            mostrarUnaMision(aux,maxTripulantes);
            break;
        case 3:
            //validarEstadoMision();
            mostrarUnaMision(aux,maxTripulantes);
...
void menuMisiones(char archivoMisiones[],char archivoNaves[], char archivoAstro[],int maxTripulantes){
    ...
    do{
        ...
        switch(opsw){
            case 1:
                crearUnaMision(archivoMisiones,archivoNaves,archivoAstro);
                break;
            case 2:
                opcionMostrarMisiones(archivoMisiones,maxTripulantes);
                break;
            case 3:
                ////consultarDatosMision();
                break;
            default:
                printf("Has ingresado mal un dato, vuelve a intentarlo!!");
                break;
        }
        puts("\nQuiere volver al menu de naves? s: ");
        fflush(stdin);
        op = getch(op);
        limpiarPantalla();
