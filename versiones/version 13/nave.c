...
void opcionesParaConsultarNaves()
{
    ...
    puts("8.Mostrar cuantas naves en mantenimiento hay (Estado= 0)");
    puts("9.Mostrar cuantas naves listas para su uso hay (Estado= 1)");
    puts("10.Mostrar cuantas naves actualmente en mision hay (Estado= 2)");
    puts("11.Mostrar cuantas naves dadas de baja hay (Estado= 3)");
