...
void lanzarMision(stMision* aux, char archivoAstro[], char archivoNaves[])
{
    aux->estado=2; // mision en vuelo
    // hay que cambiar todos los tripulantes de la mision a en mision (estado=3)
    // hay que cambiar el estado de la nave a actualmente en mision (estado=2)
